		...
		for sock in rList:
			...
			if sock == server_socket:
				...
				if name in record.values():
					...
					send_to_all(sockfd, str.encode("\33[32m\33[1m\r "+ name.decode() +" joined the conversation \n\33[0m") )
			...
			#Some incoming message from a client
				...
				try:
					...
					if data1.decode() == "tata":
						...
						msg="\r\33[1m"+"\33[35m "+record[(i,p)].decode()+": "+"\33[0m"+data1.decode()+"\n"
						send_to_all(sock, str.encode(msg) )
			
				#abrupt user exit
				except:
					(i,p)=sock.getpeername()
					send_to_all(sock, str.encode("\r\33[31m \33[1m"+record[(i,p)].decode()+" left the conversation unexpectedly\33[0m\n") )
